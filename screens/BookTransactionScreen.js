...
transactionMessage: ''
  ...
  getCameraPermissions= async()=>{
    ...
    this.setState({ /*status === "granted" is true when user has granted permission 
...
return isStudentEligible
  ...
  handleTransaction=async()=> {
     ...
     if(!transactionType){
       Alert.alert("THe book doesn't exist!")
       this.setState({
         scannedStudentId: '',
         scannedBookId: ''
       })
...
<View>
  ...
  style = {{width:200, height: 200}}/><Text style = {{textAlign: 'center', fontSize:30}}>WILY</Text>
</View>
